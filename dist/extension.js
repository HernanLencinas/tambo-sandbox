...
var CombinedStream = __webpack_require__(25);
...
var asynckit = __webpack_require__(34);
...
var util = __webpack_require__(12);
var Stream = (__webpack_require__(26).Stream);
var DelayedStream = __webpack_require__(27);
...
var extname = (__webpack_require__(19).extname)
...
module.exports =
{
  parallel      : __webpack_require__(35),
  serial        : __webpack_require__(42),
  serialOrdered : __webpack_require__(43)
};
...
var iterate    = __webpack_require__(36)
  , initState  = __webpack_require__(40)
  , terminator = __webpack_require__(41)
  ;
...
var abort = __webpack_require__(39)
...
var serialOrdered = __webpack_require__(43);
...
module.exports = function () {
  if (!debug) {
    try {
      ...
      debug = __webpack_require__(6)("follow-redirects");
    }
    catch (error) { /* */ }
...
class GruposTreeProvider {
    ...
    getChildren(element) {
        if (element) {
            ...
            return Promise.resolve(this.grupos.map(grupo => new GrupoItem(grupo.name, grupo.repositorio, grupo.branch, this.context)));
        }
    }
}
exports.GruposTreeProvider = GruposTreeProvider;
class GrupoItem extends vscode.TreeItem {
    constructor(name, repositorio, branch, context) {
...
const grupos_1 = __webpack_require__(51);
function activate(context) {
    ...
    context.subscriptions.push(vscode.commands.registerCommand('tambo.grupos.select', (item) => {
    ...
    context.subscriptions.push(vscode.commands.registerCommand('tambo.grupos.refresh', () => gruposTreeProvider.refresh()));
