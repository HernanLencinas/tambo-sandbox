...
const hash_wasm_1 = __webpack_require__(48);
class Connection {
    async wizard() {
...
async function updateStatus(vscodeURI) {
    ...
    function createStatusHTML1(title, status, clase, warningMessage) {
...
const axios_1 = __importDefault(__webpack_require__(7));
const globals_1 = __webpack_require__(46);
const simple_git_1 = __importDefault(__webpack_require__(49)); // SimpleGitOptions
...
var init_util = __esm({
  "src/lib/utils/util.ts"() {
    "use strict";
    import_file_exists = __webpack_require__(50);
    NULL = "\0";
    NOOP = () => {
    };
...
var init_completion_detection_plugin = __esm({
  "src/lib/plugins/completion-detection.plugin.ts"() {
    "use strict";
    import_promise_deferred = __webpack_require__(52);
    init_utils();
...
var init_plugin_store = __esm({
  "src/lib/plugins/plugin-store.ts"() {
    "use strict";
    import_node_events = __webpack_require__(53);
    init_utils();
    PluginStore = class {
      constructor() {
...
var init_git_executor_chain = __esm({
  "src/lib/runners/git-executor-chain.ts"() {
    "use strict";
    import_child_process = __webpack_require__(54);
    init_git_error();
    init_task();
    init_utils();
...
var init_scheduler = __esm({
  "src/lib/runners/scheduler.ts"() {
    "use strict";
    init_utils();
    import_promise_deferred2 = __webpack_require__(52);
    init_git_logger();
    createScheduledTask = (() => {
      let id = 0;
      return () => {
