...
const gitlab_1 = __webpack_require__(8);
const globals_1 = __webpack_require__(7);
class Connection {
    async wizard() {
        ...
        webviewView.webview.onDidReceiveMessage(async (message) => {
            switch (message.command) {
                case 'sandboxStatus':
                    ...
                    const workspaceRepos = workspaceStatus.data.repos_disponibles.map((repo) => ({
                        id: repo.id,
                        name: repo.path.match(/clientes\/([^\/]+)\/tambo/)[1],
                        repo: globals_1.globalConfig.gitlabUrl + '/' + repo.path + '.git',
                        branch: 'master'
                    }));
...
const axios_1 = __webpack_require__(103);
const globals_1 = __webpack_require__(7);
class Sandbox {
    ...
    async getChildren(element) {
        if (element) {
            ...
            try {
                ...
                return response.data.repos_disponibles.map((repo) => new GrupoItem(repo.path, //repo.id.toString(),
                repo.path.match(/clientes\/([^\/]+)\/tambo/)[1], this.context));
            }
            catch (error) {
...
var util = __webpack_require__(22);
var Stream = (__webpack_require__(23).Stream);
var DelayedStream = __webpack_require__(24);
...
const FormData$1 = __webpack_require__(20);
const url = __webpack_require__(27);
const proxyFromEnv = __webpack_require__(64);
const http = __webpack_require__(26);
const https = __webpack_require__(6);
const util = __webpack_require__(22);
const followRedirects = __webpack_require__(65);
const zlib = __webpack_require__(77);
...
const grupos_1 = __webpack_require__(9);
