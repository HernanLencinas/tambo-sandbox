...
async function activate(context) {
    ...
    (0, utils_1.showStatusMessage)("Listo");
}
function deactivate() { }
...
class Connection {
    ...
    async edit() {
        ...
        if (nuevoGitlabUsername || nuevoGitlabToken) {
            ...
            if (nuevoGitlabToken) {
                await configuration.update('token', (0, utils_1.encrypt)(nuevoGitlabToken), vscode.ConfigurationTarget.Global);
            }
            globals_1.globalConfig.contextConfigStatus = true;
    ...
    async delete() {
        const respuesta = await vscode.window.showInformationMessage('¿Estás seguro de que deseas eliminar la configuración de conexión a TAMBO Sandbox?', { modal: true }, // Modal para enfatizar la confirmación
        'Sí');
        if (respuesta === 'Sí') {
            const configuration = vscode.workspace.getConfiguration('tambo.sandbox.gitlab');
    ...
    load(context) {
        try {
            ...
            (0, utils_2.showStatusMessage)("Error activando la extension.");
    ...
    isConfigured() {
        ...
        const token = config.get('gitlab.token');
...
class ConnectionsViewProvider {
    ...
    resolveWebviewView(webviewView, context, token) {
        ...
        webviewView.webview.onDidReceiveMessage(async (message) => {
            switch (message.command) {
                case 'sandboxStatus':
                    if (globals_1.globalConfig.contextConfigStatus) {
                        const htmlStatusSandbox = await configureStatus();
                        globals_1.globalConfig.workspaceStatusHash = "";
                        globals_1.globalConfig.contextConfigStatus = false;
                        ...
                        const hash = (await (0, hash_wasm_1.md5)(htmlStatusSandbox)).slice(-5);
                        if (globals_1.globalConfig.workspaceStatusHash !== hash) {
                ...
                case 'showMessage':
                    ...
                    break;
                case 'sandboxCreate':
                    const createWorkspaceRes = await vscode.window.showInformationMessage('¿Desplegar un nuevo Workspace en Tambo Sandbox?', { modal: true }, 'Sí');
                ...
                case 'sandboxChangeGroup':
                    ...
                    const changeWorkspaceGroupRes = await vscode.window.showWarningMessage(`Está a punto de cambiar al grupo ${message.data.name}.\n\n` +
                        `⚠️ Este cambio afectará su configuración de trabajo actual. Se clonara el repositorio de este grupo en el workspace activo.\n\n` +
                        `¿Desea continuar?`, { modal: true }, 'Sí');
    ...
    updateWebviewContent() {
        ...
        globals_1.globalConfig.vscodeUri = this.webviewView.webview.asWebviewUri(this.context.extensionUri);
...
async function updateStatus(vscodeURI) {
    const sandbox = new sandbox_1.Sandbox();
    const gitlab = new gitlab_1.Gitlab();
    ...
    function createStatusHTML(title, status, clase, warningMessage) {
...
class Sandbox {
    ...
    async workspaceStatus() {
        try {
            ...
            return (await axios_1.default.get(`${sandboxUrl}?usuario=${encodeURIComponent(username)}`, axiosConfig)).data.estado;
        }
        catch (error) {
            return 1;
        }
...
const events = __webpack_require__(45);
...
var CombinedStream = __webpack_require__(9);
var util = __webpack_require__(10);
var path = __webpack_require__(13);
var http = __webpack_require__(14);
var https = __webpack_require__(6);
var parseUrl = (__webpack_require__(15).parse);
...
var util = __webpack_require__(10);
var Stream = (__webpack_require__(11).Stream);
var DelayedStream = __webpack_require__(12);
...
var init_util = __esm({
  "src/lib/utils/util.ts"() {
    "use strict";
    import_file_exists = __webpack_require__(49);
    NULL = "\0";
    NOOP = () => {
    };
...
var init_completion_detection_plugin = __esm({
  "src/lib/plugins/completion-detection.plugin.ts"() {
    "use strict";
    import_promise_deferred = __webpack_require__(51);
    init_utils();
...
var init_plugin_store = __esm({
  "src/lib/plugins/plugin-store.ts"() {
    "use strict";
    import_node_events = __webpack_require__(52);
    init_utils();
    PluginStore = class {
      constructor() {
...
var init_git_logger = __esm({
  "src/lib/git-logger.ts"() {
    "use strict";
    import_debug = __toESM(__webpack_require__(35));
    init_utils();
...
var init_git_executor_chain = __esm({
  "src/lib/runners/git-executor-chain.ts"() {
    "use strict";
    import_child_process = __webpack_require__(53);
    init_git_error();
    init_task();
    init_utils();
...
var init_scheduler = __esm({
  "src/lib/runners/scheduler.ts"() {
    "use strict";
    init_utils();
    import_promise_deferred2 = __webpack_require__(51);
    init_git_logger();
    createScheduledTask = (() => {
      let id = 0;
      return () => {
